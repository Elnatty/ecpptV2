...
sudo nano /etc/proxychains4.conf # scroll to end of the line, make sure same port is set with the metasploit (auxiliary/server/socks4a) module, save and exit.
